<project_overview>
GlazeWM is a window manager for Windows, written in Rust.
...
- **wm-platform** (lib): Wrappers over platform-specific APIs; other crates do not call Windows APIs directly.
- **wm-watcher** (bin): Watchdog process ensuring proper cleanup when the main application exits. Install path on Windows: `C:\Program Files\glzr.io\glazewm-watcher.exe`
