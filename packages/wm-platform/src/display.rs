...
///
/// Can be obtained with `display.id()`. Wraps a Win32 monitor handle
/// (`HMONITOR`).
...
///
/// Can be obtained with `display_device.id()`. This is a hardware ID
/// string, with a fallback to the adapter name.
